...
public class PrintBoundaryNodes {
  ...
  public void printBoundaryRight(Node node) {
    ...
    public static void main(String[] args){
        PrintBoundaryNodes a = new PrintBoundaryNodes();
        a.root = a.new Node(2);
        a.root.left = a.new Node(7);
        a.root.left.left = a.new Node(3);
        a.root.left.right = a.new Node(8);
        a.root.left.right.left = a.new Node(5);
        a.root.left.right.left.left = a.new Node(17);
        a.root.left.right.left.right = a.new Node(90);
        a.root.left.right.right = a.new Node(10);
        a.root.right = a.new Node(5);
        a.root.right.right = a.new Node(20);
        a.root.right.right.right = a.new Node(25);

        a.printBoundary(a.root);
    }
}
