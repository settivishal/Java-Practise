...
//* We traverse the doubly linked list from head to end. For every newly encountered element, we check whether it is in the hash table: if yes, we remove it; otherwise we put it in the hash table.

// Java implementation to remove duplicates from an unsorted doubly linked list
import java.util.*;

class RemoveDuplicatesUnsorted2
{
